...
class CTA_Evaluator:
  ...
  def _evaluate(self, client_payload, _context={}):
    ...
    gt_ancestor = json.load(open("DataSets/Data_CTA/cta_gt_ancestor.json"))
    gt_descendent = json.load(open("DataSets/Data_CTA/cta_gt_descendent.json"))
...
if __name__ == "__main__":
    ...
    answer_file_path = "DataSets/Data_CTA/CTA_Round4_gt.csv"
    d = '/Users/jiahen/Data/TableAnnotate/SemTab_Challenge/SemTab20/Round4/Round4_solutions/CTA2/'
