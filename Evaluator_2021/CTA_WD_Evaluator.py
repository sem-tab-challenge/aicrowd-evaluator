...
class CTA_Evaluator:
  ...
  def _evaluate(self, client_payload, _context={}):
    ...
    gt_ancestor = json.load(open("DataSets/BioDiv_CTA_WD/BioDiv_CTA_WD_gt_ancestor.json"))
    gt_descendent = json.load(open("DataSets/BioDiv_CTA_WD/BioDiv_CTA_WD_gt_descendent.json"))
...
if __name__ == "__main__":
    ...
    answer_file_path = "DataSets/BioDiv_CTA_WD/BioDiv_CTA_WD_gt.csv"
    d = 'DataSets/BioDiv_CTA_WD_Sub/'
